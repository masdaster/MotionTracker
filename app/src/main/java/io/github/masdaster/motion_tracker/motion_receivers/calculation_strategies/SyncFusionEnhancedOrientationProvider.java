 ...
 *
 */
class SyncFusionEnhancedOrientationProvider extends SyncFusionBaseOrientationProvider {
    /**
    ...
    /**
     * Initialises a new SyncFusionEnhancedOrientationProvider
     *
     * @param sensorManager The android sensor manager
     */
    public SyncFusionEnhancedOrientationProvider(SensorManager sensorManager) {
        super(sensorManager);
