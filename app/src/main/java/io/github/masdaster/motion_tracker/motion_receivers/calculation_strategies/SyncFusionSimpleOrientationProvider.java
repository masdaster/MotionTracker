 ...
 *
 */
class SyncFusionSimpleOrientationProvider extends SyncFusionBaseOrientationProvider {
    ...
    /**
     * Initialises a new SyncFusionSimpleOrientationProvider
     *
     * @param sensorManager The android sensor manager
     */
    public SyncFusionSimpleOrientationProvider(SensorManager sensorManager) {
        super(sensorManager);
